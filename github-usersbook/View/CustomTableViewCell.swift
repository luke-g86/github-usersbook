...
class CustomTableViewCell: UITableViewCell {
    ...
    func addLayoutContraints() {
        ...
        cellView.widthAnchor.constraint(equalTo: self.contentView.widthAnchor, constant: -5).isActive = true
        ...
        userNickname.trailingAnchor.constraint(equalTo: self.cellView.trailingAnchor, constant: -2).isActive = true
    }
}
