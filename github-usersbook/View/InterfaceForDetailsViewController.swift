...
//        }()
//        
//        detailView.generalContainer.addSubview(reposCard)
//        
//         
//        
//        //MARK: Section label
...
//        sectionName.topAnchor.constraint(equalTo: detailView.userCardContainerView.bottomAnchor, constant: 24).isActive = true
...
//        reposCard.widthAnchor.constraint(equalTo: detailView.userCardContainerView.widthAnchor).isActive = true
